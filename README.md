...
1. Generate the spatial and temporal domains – Define the area of interest, including the shape, extent, and spatial structure of the ecosystem.
...
4. Generate sampling designs – Define site allocation and hierarchical sampling structures.
