...
- Large-scale design: locates sites within reefs selected across the spatial domain and creates uneven repeated surveys if random site allocation is selected.  
