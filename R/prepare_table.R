...
##' @return 
##' A data frame mimicking the export structure of the ReefCloud pipeline (https://reefcloud.ai/)
##' @author Murray
##' @examples
##' library(sf)
##' library(stars)
...
##' reefcloud_synthetic_fixed_benthos <- prepare_table(benthos_fixed_locs_points)
##' @export
